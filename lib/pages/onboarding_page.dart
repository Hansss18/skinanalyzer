...
import 'package:skinanalyzer/components/button.dart';
import 'package:skinanalyzer/configs/pallete.config.dart';
import 'package:skinanalyzer/configs/route.config.dart';
  ...
  Widget _buildIndicator(int length, int currentIndex) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 8),
        Text(
          'Dengan  analisis akan membantu anda untuk menentukan perawatan kulit wajah yang dibutuhkan',
